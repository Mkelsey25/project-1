...
(function () {
    ...
    $("#section-spotify").delegate("button#btn-test-spotify","click", function() {
        ...
        // hard coded the token while in DEV (comment out before check in or remote.  has a time expiration)
